...
const theConfigs = require('./configuration');
const configuration = theConfigs.configs

const LOGISTICS_MS_ENDPOINT = configuration.LOGISTICS_MS_ENDPOINT || 'http://129.213.11.15/soaring/logistics'
...
async function getProducts() {
    var options = {
        method: 'GET',
        uri: LOGISTICS_MS_ENDPOINT+'/products',
        headers:
        {
            'cache-control': 'no-cache'
        }, json: true // Automatically parses the JSON string in the response};
...
module.exports = {
    runShippingGenerationJob: runShippingGenerationJob
}
